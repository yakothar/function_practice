...
public class Validate_input 
{
    ...
    public static void main(String[] args) 
    {
        ...
        fname = sc.next();
        boolean firstname = name_first(fname);  //Calling a Function with fname as String argument
        System.out.println("Enter the last name:");
        lname = sc.next();
        boolean lastname = name_last(lname);    // Calling a Function with lname as String argument
        System.out.println("Enter the ZIP code:");
        zip = sc.next();
        boolean zipcode = zipC(zip);            // Calling a function with zip as String argument
        System.out.println("Enter an employee ID:");
        emp_id = sc.next();
        boolean employeeId = employee(emp_id);  // Calling a function with emp_id as String argument
